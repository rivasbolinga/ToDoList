...
```
git clone https://github.com/rivasbolinga/To-Do-List.git
```
...
This project is [MIT](https://github.com/rivasbolinga/To-Do-List/blob/list-structure/MIT.md) licensed.
